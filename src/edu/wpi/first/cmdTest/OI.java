...
import edu.wpi.first.cmdTest.commands.LogPotVoltage;
import edu.wpi.first.cmdTest.commands.MainMotorGo;
import edu.wpi.first.cmdTest.commands.MainMotorGoVariable;
import edu.wpi.first.cmdTest.commands.PotMotorControl;
import edu.wpi.first.cmdTest.commands.PrintCommand;
...
public class OI {
    ...
    public OI(){
//        b1.whileHeld(new LogPotVoltage());
        b4.whenPressed(new MainMotorGoVariable());
        b1.whenPressed(new PotMotorControl());
